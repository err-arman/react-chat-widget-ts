...
import { MessageTypes, Link, CustomCompMessage, GlobalState } from '@/types/StoreTypes';
import { MESSAGE_SENDER } from '../../../../../../constants';

import Loader from './components/Loader';
import './styles.scss';
import { markAllRead, setBadgeCount } from 'redux/slices/messagesSlice';
...
function Messages({ profileAvatar, profileClientAvatar, showTimeStamp }: Props) {
  ...
  useEffect(() => {
    ...
    if (showChat && badgeCount) dispatch(markAllRead(messages));
